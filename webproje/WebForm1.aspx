<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="webproje.WebForm1" %>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="WebForm1.aspx">Register <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="mailttxt">E-mail:</label>
                        <asp:TextBox ID="mailttxt" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="Register" CssClass="btn btn-block" />
                    </div>
